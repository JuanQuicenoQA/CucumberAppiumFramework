...
public class BasePage {
    ...
    public void closeApp() {
        switch (new GlobalParams().getPlatformName()) {
            case "Android" -> ((InteractsWithApps) driver).terminateApp(driver.getCapabilities().
                    getCapability("appPackage").toString());
            case "iOS" -> ((InteractsWithApps) driver).terminateApp(driver.getCapabilities().
    ...
    public void launchApp() {
        switch (new GlobalParams().getPlatformName()) {
            case "Android" -> ((InteractsWithApps) driver).activateApp(driver.getCapabilities().
                    getCapability("appPackage").toString());
            case "iOS" -> ((InteractsWithApps) driver).activateApp(driver.getCapabilities().
                    getCapability("bundleId").toString());
        }
    }
